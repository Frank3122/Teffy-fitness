"""
Django settings for teffyfitness project.
...
SECRET_KEY = 'django-insecure-m4z=v_sp)=x)au)yny&fdb-)ayi5oxc%9opz+25t-koo#6p4-e'
...
ROOT_URLCONF = 'teffyfitness.urls'
...
WSGI_APPLICATION = 'teffyfitness.wsgi.application'
